...
import sty from "./PlasmicProgressBar.module.css"; // plasmic-import: uN6JtswiqsYW/css
...
function PlasmicProgressBar__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox___9RkDh)}>
        <div className={classNames(projectcss.all, sty.freeBox__wo1Qa)} />

        <div className={classNames(projectcss.all, sty.freeBox__bZUr)} />
      </div>
    </div>
