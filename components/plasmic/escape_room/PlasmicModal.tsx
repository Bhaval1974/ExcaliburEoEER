...
import Button from "../../Button"; // plasmic-import: omSd4rWm42Ka/component
...
import sty from "./PlasmicModal.module.css"; // plasmic-import: 8s0Hs3vwzgcv/css
    ...
    <BaseDialogTrigger
      ...
      dialog={
        <BaseModal
          ...
          modalOverlayClass={classNames({ [sty["pcls_JiL-ePQhLFa1"]]: true })}
          ...
          >
            ...
            >
              {renderPlasmicSlot({
                defaultContents: (
                  <div
                    className={classNames(projectcss.all, sty.freeBox__fs2Yp)}
                  >
                    <div
                      className={classNames(
                        projectcss.all,
            ...
            {renderPlasmicSlot({
              defaultContents: (
                <div className={classNames(projectcss.all, sty.freeBox__rlVpx)}>
                  <Button
                    color={"muted"}
                    label={
                      <div
